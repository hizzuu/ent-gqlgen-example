...
func (e ImageEdges) PostsOrErr() (*Post, error) {
	if e.loadedTypes[0] {
		if e.Posts == nil {
...
// QueryPosts queries the "posts" edge of the Image entity.
func (i *Image) QueryPosts() *PostQuery {
	return (&ImageClient{config: i.config}).QueryPosts(i)
}
